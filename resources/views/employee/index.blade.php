        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <button type="button" id="createEmployee" class="btn btn-success mb-2" data-toggle="modal" data-target="#createModal">Create new Employee</button>
                           ...
                           @foreach($data as $employee)
                               <tr>
                                   ...
                                   <td>
                                       ...
                                       <a href="{{url('employees/show/'.$employee->id)}}"    class="btn btn-success">show</a>
                ...
                <div class="modal-body">
                    ...
                    <form method="POST" id="employeeUpdateForm"  enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select name="company_u" id="company_u" class="form-control" required>
                                    <option value="">Select company</option>
                                    @foreach($companies as $company)
                                        <option value="{{$company->id}}">{{$company->name}}</option>
                                    @endforeach
...
<script>
    ...
    function updateModal(id){
        ...
        $.ajax({
            url:'{{url('employees/getEmployeeDetails')}}',
            type:'post',
